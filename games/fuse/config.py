...
# ENV
BOARD_WIDTH_TILES = 31
BOARD_HEIGHT_TILES = 25
SCREEN_WIDTH = screen_width(DEFAULT_GRID_COLUMNS, TILE_SIZE)
SCREEN_HEIGHT = screen_height(DEFAULT_GRID_ROWS, TILE_SIZE, BB_HEIGHT)
WORLD_WIDTH = int(SCREEN_WIDTH)
WORLD_HEIGHT = int(SCREEN_HEIGHT - BB_HEIGHT)
ARENA_FRAME_PADDING = 8.0
ARENA_FRAME_BORDER_WIDTH = 7.12
