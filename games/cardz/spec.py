...
SPEC = GameSpec(
    ...
    summary="Tiny 3-lane card duel with compact public-information P1 observations, scripted P2 curriculum, ATK/BAN lane play, masked actions, and A2C-oriented defaults.",
