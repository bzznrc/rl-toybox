...
SPEC = GameSpec(
    ...
    family="actor_critic",
    role="Single-agent hidden-information actor-critic showcase versus a scripted opponent.",
    summary="Tiny 3-lane card duel with structured public-information P1 observations, explicit categorical flags, scripted P2 curriculum, ATK/BAN lane play, masked actions, and A2C-oriented defaults.",
